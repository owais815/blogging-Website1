...
function Home() {
  ...
  const fetchProducts = async () => {
    try {
      const url =
        "https://user-authentication-complete-app-api.vercel.app/products";
      const headers = {
        headers: {
  ...
  return (
    ...
    <div>
      ...
      <link rel="canonical" href="https://demo.themesberg.com/Owais/" />
      <meta charSet="UTF-8" />
      <meta httpEquiv="X-UA-Compatible" content="IE=edge" />
      <meta name="viewport" content="width=device-width, initial-scale=1.0" />
      <title>Owais - Tailwind CSS Landing Page Demo</title>

      {/* Meta SEO */}
      <meta name="title" content="Owais - Tailwind CSS Landing Page" />
      <meta
        name="description"
      ...
      {/* Social media share */}
      <meta property="og:title" content="Owais - Tailwind CSS Landing Page" />
      <meta property="og:site_name" content="Themesberg" />
      <meta property="og:url" content="https://demo.themesberg.com/Owais/" />
      <meta
      ...
      <meta
        property="og:image"
        content="https://themesberg.s3.us-east-2.amazonaws.com/public/github/Owais/og-image.png"
      />
          ...
          <div className="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            <div className="mr-auto place-self-center lg:col-span-7">
              ...
              <div className="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                <a
                  href="https://github.com/themesberg/Owais"
                  ...
                  {products.length > 0 ? (
                    products.map((item, index) => (
                      <ul key={index} className="list-disc ml-5">
                        <li className="text-base font-medium leading-tight text-gray-900 dark:text-white">
            ...
            <div className="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
              <div>
                ...
                <p className="font-light text-gray-500 dark:text-gray-400">
                  For Owais, with zero maintenance downtime
                </p>
              </div>
              <div>
                <svg
              ...
              <div>
                ...
                <p className="font-light text-gray-500 dark:text-gray-400">
                  Have used Owais to create functional websites
                </p>
              </div>
              <div>
                <svg
        ...
        <section className="bg-gray-50 dark:bg-gray-800">
          <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-24 lg:px-6">
            <figure className="max-w-screen-md mx-auto">
              ...
              <blockquote>
                <p className="text-xl font-medium text-gray-900 md:text-2xl dark:text-white text-center">
                  "wasi is just awesome. It contains tons of pre-designed
          ...
          <div className="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
            <div className="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
              ...
              <p className="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">
                Here at Owais we focus on markets where technology, innovation,
            ...
            <div className="max-w-screen-md mx-auto">
              ...
              >
                <h3 id="accordion-flush-heading-1">
                  ...
                  >
                    <span>Can I use Owais in open-source projects?</span>
                    <svg
                      data-accordion-icon=""
                ...
                >
                  <div className="py-5 border-b border-gray-200 dark:border-gray-700">
                    <p className="mb-2 text-gray-500 dark:text-gray-400">
                      Owais is an open-source library of interactive components
                ...
                >
                  <div className="py-5 border-b border-gray-200 dark:border-gray-700">
                    <p className="mb-2 text-gray-500 dark:text-gray-400">
                      Owais is first conceptualized and designed using the Figma
                    ...
                    <p className="text-gray-500 dark:text-gray-400">
                      ...
                      based on the utility classnames from Tailwind CSS and
                      components from Owais.
                    </p>
                  </div>
                </div>
                <h3 id="accordion-flush-heading-3">
                  ...
                  >
                    <span>
                      What are the differences between Owais and Tailwind UI?
                    </span>
                    <svg
                      data-accordion-icon=""
                      className="w-6 h-6 shrink-0"
                ...
                >
                  <div className="py-5 border-b border-gray-200 dark:border-gray-700">
                    <p className="mb-2 text-gray-500 dark:text-gray-400">
                      The main difference is that the core components from Owais
                      are open source under the MIT license, whereas Tailwind UI
                      is a paid product. Another difference is that Owais relies
                      on smaller and standalone components, whereas Tailwind UI
                      offers sections of pages.
                    </p>
                    <p className="mb-2 text-gray-500 dark:text-gray-400">
                      However, we actually recommend using both Owais, Owais
          ...
          <div className="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
            <div className="max-w-screen-sm mx-auto text-center">
              ...
              <p className="mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">
                Try Owais Platform for 30 days. No credit card required.
              </p>
              <a
                href="#"
          ...
          <div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
            ...
            <div className="text-center">
              ...
              <span className="block text-sm text-center text-gray-500 dark:text-gray-400">
                © 2021-2022 Owais™. All Rights Reserved. Built with{" "}
                <a
                  href="#"

        ...
        <div className="border-b border-stroke py-4 px-7 dark:border-strokedark">
          ...
          <form>
            <div className="grid grid-cols-3 gap-5 justify-normal">
              ...
              <div className="form-group w-full">
                ...
                <div className="relative z-20 w-full rounded border border-stroke p-1.5 pr-8 font-medium outline-none transition focus:border-primary active:border-primary dark:border-strokedark dark:bg-form-input">
                  <div className="flex flex-wrap items-center"></div>
                  <span className="m-1.5 flex items-center justify-center rounded border-[.5px] border-stroke bg-gray py-1.5 px-2.5 text-sm font-medium dark:border-strokedark dark:bg-white/30">
                    {formState.type === "0" ? "Price" : formState.type === "1" ? "Market Cap" : formState.type === "2" ? "Dividend Yield" : formState.type === "3" ? "PE Ratio" : "P/B Ratio"}
                  </span>
                  <select
                    className="absolute top-0 left-0 z-20 h-full w-full bg-transparent opacity-0"
                    name="type"
                  ...
                  >
                    ...
                    <option value="2">Dividend Yield</option>
                    <option value="3">PE Ratio</option>
                    <option value="4">P/B Ratio</option>
                  </select>
                  <span className="absolute top-1/2 right-4 z-10 -translate-y-1/2">
                    <svg
                      width="24"
            ...
            <div className="mt-5 flex justify-end">
              <button
                className="inline-flex items-center rounded bg-primary px-4 py-2 text-white hover:bg-primarydark focus:outline-none"
                type="submit"
